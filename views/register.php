        ...
        <section class="max-w-md mx-auto">
            <div class="bg-white rounded-xl shadow-2xl p-8 animate-fade-in">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600">Completa todos los campos para registrarte</p>
                </div>
                ...
                <form action="?route=register-process" method="POST" id="registerForm" class="space-y-6">
                    <!-- Campo Nombre -->
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="nombre" 
                            name="nombre" 
                            value="<?php echo htmlspecialchars($old_data['nombre'] ?? ''); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="correo" 
                            name="correo" 
                            value="<?php echo htmlspecialchars($old_data['correo'] ?? ''); ?>"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 hover:border-gray-400"
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-strength mt-2">
                            <div class="bg-gray-200 rounded-full h-2">
                                <div id="strength-bar" class="bg-gray-300 h-2 rounded-full transition-all duration-300" style="width: 0%"></div>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        >
                            ...
                            <option value="usuario" <?php echo (($old_data['tipo_usuario'] ?? '') === 'usuario') ? 'selected' : ''; ?>>Usuario</option>
                            <option value="admin" <?php echo (($old_data['tipo_usuario'] ?? '') === 'admin') ? 'selected' : ''; ?>>Administrador</option>
                        </select>
                        <div class="error-message text-red-500 text-sm mt-1 hidden"></div>
                    </div>
                ...
                <div class="text-center mt-6">
                    <p class="text-gray-600">
                        ...
                        <a href="?route=login" class="text-indigo-600 hover:text-indigo-800 font-medium transition-colors duration-200">
                            Inicia sesión aquí
                        </a>
                    </p>
                </div>
